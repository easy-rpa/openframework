...
public class ExcelCellStyle {
     ...
     * Cells data format.
     */
    private eu.easyrpa.openframework.excel.style.DataFormat dataFormat = DataFormats.GENERAL.get();
     ...
     */
    private eu.easyrpa.openframework.excel.Cell cell;
     ...
     */
    public ExcelCellStyle(eu.easyrpa.openframework.excel.Cell cell) {
        ...
        dataFormat = new eu.easyrpa.openframework.excel.style.DataFormat(cellStyle.getDataFormat(), cellStyle.getDataFormatString());
     ...
     * @return this cell style object to allow joining of methods calls into chain.
     * @see eu.easyrpa.openframework.excel.style.DataFormat
     */
    public ExcelCellStyle format(eu.easyrpa.openframework.excel.style.DataFormat format) {
    ...
    public ExcelCellStyle format(String format) {
        ...
        this.dataFormat = fInx >= 0 ? new eu.easyrpa.openframework.excel.style.DataFormat((short) fInx, format) : new DataFormat(format);
        this.isDirty = true;
        return this;
    }
     ...
     */
    public void applyTo(eu.easyrpa.openframework.excel.Cell cell) {
        int documentId = cell.getDocument().getId();
        int sheetIndex = cell.getSheetIndex();

        eu.easyrpa.openframework.excel.CellRange mr = cell.getMergedRegion();
        if (mr == null) {
