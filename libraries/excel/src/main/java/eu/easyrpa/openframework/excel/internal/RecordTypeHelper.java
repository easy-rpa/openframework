...
import eu.easyrpa.openframework.excel.annotations.ExcelCellStyle;
...
public class RecordTypeHelper<T> {
    ...
    private eu.easyrpa.openframework.excel.style.ExcelCellStyle tableHeaderCellStyle = null;
    private eu.easyrpa.openframework.excel.style.ExcelCellStyle tableCellStyle = null;
    ...
    private Map<Integer, eu.easyrpa.openframework.excel.style.ExcelCellStyle> columnHeaderCellStyleMap = new HashMap<>();
    private Map<Integer, eu.easyrpa.openframework.excel.style.ExcelCellStyle> columnCellStyleMap = new HashMap<>();
    ...
    public void formatCell(Cell cell, String columnName, int recordIndex, List<T> records) {
        ...
        if (cell != null && columnName != null && !columnName.trim().isEmpty()) {
            ...
            eu.easyrpa.openframework.excel.style.ExcelCellStyle cellStyle = columnCellStyleMap.get(columnOrder);
            if (cellStyle != null) {
    ...
    public void formatHeaderCell(Cell cell, String columnName) {
        ...
        if (cell != null && columnName != null && !columnName.trim().isEmpty()) {
            ...
            eu.easyrpa.openframework.excel.style.ExcelCellStyle headerCellStyle = columnHeaderCellStyleMap.get(columnOrder);
    ...
    public static <T> RecordTypeHelper<T> getFor(Class<T> recordType) {
        ...
        try {
            ...
            if (tableAnnotation != null) {
                ExcelCellStyle[] styleAnnotations = tableAnnotation.cellStyle();
            ...
            for (Field field : recordType.getDeclaredFields()) {
                ...
                if (columnAnnotation != null) {
                    ...
                    ExcelCellStyle[] styleAnnotations = columnAnnotation.cellStyle();
                    if (styleAnnotations.length > 0) {
    ...
    private static eu.easyrpa.openframework.excel.style.ExcelCellStyle getStyleForAnnotation(
            ExcelCellStyle styleAnnotation) {
        eu.easyrpa.openframework.excel.style.ExcelCellStyle style = new eu.easyrpa.openframework.excel.style.ExcelCellStyle();
