...
public class Cell {
     ...
     */
    private eu.easyrpa.openframework.excel.Sheet parent;
     ...
     */
    protected Cell(eu.easyrpa.openframework.excel.Sheet parent, int rowIndex, int columnIndex) {
        this.parent = parent;
     ...
     */
    public eu.easyrpa.openframework.excel.CellRange getMergedRegion() {
