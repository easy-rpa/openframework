package eu.ibagroup.easyrpa.openframework.google.sheets.function;
...
public interface FieldMapper {
     ...
     *                   of values. This index is present <b>only if {@link GSheetColumn#name()} is specified</b>
