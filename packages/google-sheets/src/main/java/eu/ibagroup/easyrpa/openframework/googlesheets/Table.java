 ...
 * mapped to corresponding table columns using {@link eu.ibagroup.easyrpa.openframework.googlesheets.annotations.GSheetTable}
 ...
 *            {@link eu.ibagroup.easyrpa.openframework.googlesheets.annotations.GSheetTable}.
 * @see eu.ibagroup.easyrpa.openframework.googlesheets.annotations.GSheetColumn
 * @see eu.ibagroup.easyrpa.openframework.googlesheets.annotations.GSheetCellStyle
 */
public class Table<T> implements Iterable<T> {
     ...
     * {@link eu.ibagroup.easyrpa.openframework.googlesheets.annotations.GSheetColumn} annotations. These annotations
