...
public class Row implements Iterable<Cell> {
    ...
    protected Row(GSheet parent, int rowIndex) {
        this.parent = parent;
    ...
    private class CellIterator implements Iterator<Cell> {
        ...
        public CellIterator(RowData gSheetRowRow) {
            this.gSheetRow = gSheetRowRow;
            this.cellsCount = gSheetRowRow.getValues().size();
        }
