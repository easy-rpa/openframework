...
public class MsSqlServerService {
    ...
    @Inject
    public MsSqlServerService(RPAServicesAccessor rpaServices) {
    ...
    public MsSqlServerService(String driver, String dbURL, String userName, String password) {
        this.driver = driver;
        this.dbURL = dbURL;
    ...
    public MsSqlServerService driver(String driver) {
        setDriver(driver);
        return this;
    }

    public MsSqlServerService dbURL(String dbURL) {
        setDbURL(dbURL);
        return this;
    }

    public MsSqlServerService userName(String userName) {
        setUserName(userName);
        return this;
    }

    public MsSqlServerService password(String password) {
