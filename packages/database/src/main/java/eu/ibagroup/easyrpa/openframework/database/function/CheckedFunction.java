...
public interface CheckedFunction<T, R> {
     ...
     */
    default <V> CheckedFunction<V, R> compose(java.util.function.Function<? super V, ? extends T> before) {
     ...
     */
    default <V> CheckedFunction<T, V> andThen(java.util.function.Function<? super R, ? extends V> after) {
