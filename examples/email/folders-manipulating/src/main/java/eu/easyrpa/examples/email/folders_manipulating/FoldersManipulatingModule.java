package eu.easyrpa.examples.email.folders_manipulating;

import eu.easyrpa.examples.email.folders_manipulating.tasks.CreateNewFolder;
import eu.easyrpa.examples.email.folders_manipulating.tasks.DeleteFolder;
import eu.easyrpa.examples.email.folders_manipulating.tasks.RenameFolder;
