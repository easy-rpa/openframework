package eu.easyrpa.examples.excel.excel_file_editing;

import eu.easyrpa.examples.excel.excel_file_editing.tasks.EditCellsOnSheet;
import eu.ibagroup.easyrpa.engine.annotation.ApModuleEntry;
import eu.ibagroup.easyrpa.engine.apflow.ApModule;
import eu.ibagroup.easyrpa.engine.apflow.TaskOutput;
import eu.ibagroup.easyrpa.engine.boot.ApModuleRunner;
import eu.easyrpa.examples.excel.excel_file_editing.tasks.EditRecordsOnSheet;
