# Getting of files from Google Drive

This example demonstrates using of GoogleDrive library functionality to list all files from Google Drive.
...
public void execute() {
    ...
    List<GoogleFileInfo> files = googleDrive.listFiles();
    
    for(GoogleFileInfo file : files){
        ...
    }
}
```
...
6. Run `main()` method of `DriveFilesListingModule` class.

[down_git_link]: https://downgit.github.io/#/home?url=https://github.com/easy-rpa/openframework/tree/main/examples/google-drive/drive-files-listing
