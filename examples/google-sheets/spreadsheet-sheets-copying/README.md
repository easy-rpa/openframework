# Copying of sheet from one Spreadsheet to another

This example demonstrates copying of sheet from one Google Spreadsheet file to another with preserving of all original 
styles.  
...
6. Run `main()` method of `SpreadsheetSheetsCopyingModule` class.

[down_git_link]: https://downgit.github.io/#/home?url=https://github.com/easy-rpa/openframework/tree/main/examples/google-sheets/spreadsheet-sheets-copying
        ...
        <pre>
{
    ...
    <tr><td valign="top"><code>target.spreadsheet.file.id</code></td><td>
         File ID of target Google Spreadsheet file where the sheet has to be copied.<br>
         <br>
         Expected content of the target spreadsheet can be found in <code>'sheet_copy_target.xlsx'</code> file located at 
         <code>src/main/resources</code> directory. This file can be used for creation of necessary source Google 
         Spreadsheet in Google Drive.   
    </td></tr>
</table>