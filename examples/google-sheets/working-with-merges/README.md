...
This example demonstrates using of GoogleSheets library functionality to merge/unmerge cell groups in Google Spreadsheet
and read/edit its values.
...
6. Run `main()` method of `WorkingWithMergesModule` class.

[down_git_link]: https://downgit.github.io/#/home?url=https://github.com/easy-rpa/openframework/tree/main/examples/google-sheets/working-with-merges
