package eu.easyrpa.examples.database.tables_manipulating;

import eu.ibagroup.easyrpa.engine.annotation.ApModuleEntry;
import eu.ibagroup.easyrpa.engine.apflow.ApModule;
import eu.ibagroup.easyrpa.engine.apflow.TaskOutput;
import eu.ibagroup.easyrpa.engine.boot.ApModuleRunner;
import eu.easyrpa.examples.database.tables_manipulating.tasks.DropEntityTable;
import eu.easyrpa.examples.database.tables_manipulating.tasks.CreateEntityTables;
