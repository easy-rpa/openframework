...
import eu.ibagroup.easyrpa.examples.database.mysql_query_data_manipulation.utils.DbUtils;
...
@Slf4j
@ApTaskEntry(name = "Delete Obsolete Records", description = "Delete obsolete records from MySQL table")
